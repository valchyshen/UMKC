...
\captionsetup{width=1\linewidth,labelfont=bf}
    ...
    \draw[help lines,white] (0,0) grid (22,28);  
        ...
        \draw[<->] (0,28) -- (11.9,28) node[midway,above]% 
            {\textbf{United States} money of account: US dollar};
        \draw[<->] (12.2,28) -- (22,28) node[midway,above]% 
        ...
        \draw[blue,thick] (a) -- (b);
        \node[black,align=left,font=\fontsize{8}{8}\selectfont] at (17,27)%
        ...
        \node[above=10pt,align=left,font=\fontsize{8}{8}\selectfont] at (AA.north) {Italian units running US dollar books\\the Italian lira DCRs are omitted};
    \end{tikzpicture}
 \caption[Debt-credit pairs due today continuously at international perspective, pre-Euro.]%
  {Debt-credit pairs due today continuously at international perspective, pre-Euro.\par\vspace{.05in}Source: narrative from (Minsky 1986,1992), illustration by author.}
